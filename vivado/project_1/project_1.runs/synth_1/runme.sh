...
HD_PWD='/home/jam/Downloads/chisel/vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CMVM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CMVM.tcl
